...
/*    @Autowired
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/login").permitAll() //all users can access this page
                ...
                //comment this line below to request authentication to access the APIs
                .antMatchers("/api/**/").permitAll()
                .antMatchers("/admin/**", "/users/**", "/settings/**").hasAuthority("ADMIN") // only admins can access this page
